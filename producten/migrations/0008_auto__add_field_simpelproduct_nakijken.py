...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpelProduct.nakijken'
        db.add_column(u'producten_simpelproduct', 'nakijken',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SimpelProduct.nakijken'
        db.delete_column(u'producten_simpelproduct', 'nakijken')

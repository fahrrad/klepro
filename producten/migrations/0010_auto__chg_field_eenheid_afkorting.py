...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Eenheid.afkorting'
        db.alter_column(u'producten_eenheid', 'afkorting', self.gf('django.db.models.fields.CharField')(unique=True, max_length=15))

    def backwards(self, orm):

        # Changing field 'Eenheid.afkorting'
        db.alter_column(u'producten_eenheid', 'afkorting', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True))

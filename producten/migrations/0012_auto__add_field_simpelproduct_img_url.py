...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpelProduct.img_url'
        db.add_column(u'producten_simpelproduct', 'img_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SimpelProduct.img_url'
        db.delete_column(u'producten_simpelproduct', 'img_url')
    ...
    models = {
        ...
        u'producten.simpelproduct': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_url': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Leverancier', fields ['email']
        db.delete_unique(u'producten_leverancier', ['email'])


    def backwards(self, orm):
        # Adding unique constraint on 'Leverancier', fields ['email']
        db.create_unique(u'producten_leverancier', ['email'])

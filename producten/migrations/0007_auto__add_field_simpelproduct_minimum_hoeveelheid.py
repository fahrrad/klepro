...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpelProduct.minimum_hoeveelheid'
        db.add_column(u'producten_simpelproduct', 'minimum_hoeveelheid',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SimpelProduct.minimum_hoeveelheid'
        db.delete_column(u'producten_simpelproduct', 'minimum_hoeveelheid')
